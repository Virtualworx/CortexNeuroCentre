                    ...
                    <!-- Team Member Skills Bar Start -->
                        ...
                        <div class="about-member-info">
                            ...
                            <div class="member-info-content">
                                ...
                                <p class="wow fadeInUp" data-wow-delay="0.25s">Diagnostika a terapie skolióz - interdisciplinární přístup (RehaEduca)</p>

                                <p class="wow fadeInUp" data-wow-delay="0.25s">Kurz mobilizačních technik kloubních struktur (Mgr. Maja Špiritović, Ph.D. - FYZIOTALENT)</p>

                                <p class="wow fadeInUp" data-wow-delay="0.25s">Kineziotaping (EposTape)</p>
                            </div>
                        </div>
                        <!-- About Member Info End -->
