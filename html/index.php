            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="service-item wow fadeInUp">
                        ...
                        <div class="service-footer">
                            <a href="vyvojova-poradna.php" class="service-btn"><img src="images/arrow-white.svg" alt="">
                            </a>
                        </div>
                        <!-- Service Footer End -->
                    </div>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="service-item wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <!-- Service Footer Start -->
                        <div class="service-footer">
                            <a href="fyzioterapie-pro-deti.php" class="service-btn"><img src="images/arrow-white.svg" alt="">
                            </a>
                        </div>
                        <!-- Service Footer End -->
                    </div>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="service-item wow fadeInUp" data-wow-delay="0.4s">
                        ...
                        <!-- Service Footer Start -->
                        <div class="service-footer">
                            <a href="fyzioterapie-domu.php" class="service-btn"><img src="images/arrow-white.svg" alt="">
                            </a>
                        </div>
                        <!-- Service Footer End -->
                    </div>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="service-item wow fadeInUp" data-wow-delay="0.6s">
                        ...
                        <!-- Service Footer Start -->
                        <div class="service-footer">
                            <a href="intenzivni-terapie.php" class="service-btn"><img src="images/arrow-white.svg" alt="">
                            </a>
                        </div>
                        <!-- Service Footer End -->
                    </div>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="service-item wow fadeInUp" data-wow-delay="0.8s">
                        ...
                        <!-- Service Footer Start -->
                        <div class="service-footer">
                            <a href="ergoterapie.php" class="service-btn"><img src="images/arrow-white.svg" alt="">
                            </a>
                        </div>
                        <!-- Service Footer End -->
                    </div>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="service-item wow fadeInUp" data-wow-delay="1s">
                        ...
                        <!-- Service Footer Start -->
                        <div class="service-footer">
                            <a href="fyzioterapie-pro-dospele.php" class="service-btn"><img src="images/arrow-white.svg" alt="">
                            </a>
                        </div>
                        <!-- Service Footer End -->
                    </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="testimonial-slider">
                        <div class="swiper">
                            <div class="swiper-wrapper" data-cursor-text="Táhni">
                                    ...
                                    <div class="testimonial-item">
                                        ...
                                        <div class="testimonial-body">
                                            <div class="author-image">
                                                <figure class="image-anime">
                                                    <img src="images/unnamed V.png" alt="">
                                                </figure>
                                            </div>            
                                ...
                                <div class="swiper-slide">
                                    <div class="testimonial-item">
                                        ...
                                        <div class="testimonial-body">
                                            <div class="author-image">
                                                <figure class="image-anime">
                                                    <img src="images/michaela_tydlackova.png" alt="">
                                                </figure>
                                            </div>            
                                            <div class="author-content">
                                ...
                                <div class="swiper-slide">
                                    <div class="testimonial-item">
                                        ...
                                        <div class="testimonial-body">
                                            <div class="author-image">
                                                <figure class="image-anime">
                                                    <img src="images/lucie_bruzova.png" alt="">
                                                </figure>
                                            </div>            
                                            <div class="author-content">
                                                <h3>Lucie Brůžová</h3>
                                ...
                                <div class="swiper-slide">
                                    <div class="testimonial-item">
                                        ...
                                        <div class="testimonial-body">
                                            <div class="author-image">
                                                <figure class="image-anime">
                                                    <img src="images/kristyna_valovapng.png" alt="">
                                                </figure>
                                            </div>            
                                            <div class="author-content">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="blog-item wow fadeInUp">
                        <div class="post-featured-image" data-cursor-text="Zobrazit">
                            <figure>
                                <a href="<?php echo $post['link']; ?>" class="image-anime">
                        ...
                        <div class="post-item-content">
                            ...
                            <div class="post-item-footer">
                                <a href="<?php echo $post['link']; ?>" class="readmore-btn">Zobrazit více</a>
                            </div>
                        </div>
                    </div>
                </div>
