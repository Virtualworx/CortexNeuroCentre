...
<?php include 'header.php'; ?>
    ...
    <div class="page-services">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="service-item wow fadeInUp">
                        ...
                        <div class="service-footer">
                            <a href="vyvojova-poradna.html" class="service-btn">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="service-item wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <div class="service-footer">
                            <a href="fyzioterapie-pro-deti.html" class="service-btn">
                                <img src="images/arrow-white.svg" alt="">
                            </a>
                        </div>
                    </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="service-item wow fadeInUp" data-wow-delay="0.4s">
                        ...
                        <div class="service-footer">
                            <a href="fyzioterapie-domu.html" class="service-btn">
                                <img src="images/arrow-white.svg" alt="">
                            </a>
                        </div>
                    </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="service-item wow fadeInUp" data-wow-delay="0.6s">
                        ...
                        <div class="service-footer">
                            <a href="intenzivni-terapie.html" class="service-btn">
                                <img src="images/arrow-white.svg" alt="">
                            </a>
                        </div>
                    </div>
            ...
            <!-- Druhá řada - 2 sloupce zarovnané na střed -->
            <div class="row justify-content-center">
                <div class="col-lg-3 col-md-6">
                    <div class="service-item wow fadeInUp" data-wow-delay="0.8s">
                        ...
                        <div class="service-footer">
                            <a href="ergoterapie.html" class="service-btn">
                                <img src="images/arrow-white.svg" alt="">
                            </a>
                        </div>
                    </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="service-item wow fadeInUp" data-wow-delay="1s">
                        ...
                        <div class="service-footer">
                            <a href="fyzioterapie-pro-dospele.html" class="service-btn">
                                <img src="images/arrow-white.svg" alt="">
                            </a>
                        </div>
                    </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6">
                        <div class="cta-appointment-btn">
                            <a href="https://my.medevio.cz/cortex-neuro-centre/pozadavky/skupina/novy-pacient" class="btn-default">
